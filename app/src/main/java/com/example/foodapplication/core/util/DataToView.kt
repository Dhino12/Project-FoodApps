package com.example.foodapplication.core.util
...
import com.example.foodapplication.ui.detail.food.IngredientsAdapter
import com.example.foodapplication.ui.detail.food.TimelineAdapter
    ...
    companion object{
        ...
        fun getInstance(
                ...
                instance ?: synchronized(this){
                    instance ?: DataToView(binding, context, viewModel)
                }
    }
