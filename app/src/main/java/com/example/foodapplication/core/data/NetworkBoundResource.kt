package com.example.foodapplication.core.data
...
abstract class NetworkBoundResource<ResultType, RequestType> {
    ...
    init {
        ...
        Log.e("errorShouldMasukNet1",dbSource.toList().toString())
        val db = dbSource
                ...
                .subscribe { value ->
                    ...
                    if (shouldFetch(value)) {
                        Log.e("errorShould",shouldFetch(value).toString())
                        fetchFromNetwork()
                    } else {
    ...
    private fun fetchFromNetwork() {
        ...
        Log.e("errorNet","masuk FetchFromNet")
